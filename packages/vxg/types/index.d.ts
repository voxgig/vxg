...
declare const Vxg: Vxg
export default Vxg
export interface Vxg {
  framework: Framework
  install: PluginFunction<VxgUseOptions>
  preset: VxgPreset
  userPreset: UserVxgPreset
  version: string
  config: Config
  new(preset?: Partial<UserVxgPreset>): Vxg
}
...
export { Presets, VxgPreset, UserVxgPreset } from './services/presets'

export type ComponentOrPack = Component & {
  $_vxg_subcomponents?: Record<string, ComponentOrPack>
}

export interface VxgUseOptions {
